...
workdir=/home/maxnest/Pdum_ref_Trinity
...
nohup /home/maxnest/Soft/Trinity/trinityrnaseq-v2.14.0/Trinity --seqType fq --max_memory 100G --left $R1 --right $R2 --SS_lib_type FR --CPU 24 --min_contig_length 200 --output $TAG --no_salmon --full_cleanup
wait
