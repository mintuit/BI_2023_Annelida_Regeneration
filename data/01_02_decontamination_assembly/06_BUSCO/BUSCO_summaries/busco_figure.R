...
# Output
my_output <- paste("/mnt/f/phylo/WORMS/busco_analysis/new_transcriptomes/BUSCO_summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('Pdum_draft', 'Pdum_draft', 'Pdum_draft', 'Pdum_draft', 'Pdum_final_assembly', 'Pdum_final_assembly', 'Pdum_final_assembly', 'Pdum_final_assembly', 'Pdum_rnaSPAdes', 'Pdum_rnaSPAdes', 'Pdum_rnaSPAdes', 'Pdum_rnaSPAdes', 'Pdum_Trinity', 'Pdum_Trinity', 'Pdum_Trinity', 'Pdum_Trinity', 'Pele_draft', 'Pele_draft', 'Pele_draft', 'Pele_draft', 'Pele_final_assembly', 'Pele_final_assembly', 'Pele_final_assembly', 'Pele_final_assembly', 'Pele_rnaSPdes', 'Pele_rnaSPdes', 'Pele_rnaSPdes', 'Pele_rnaSPdes', 'Pele_Trinity', 'Pele_Trinity', 'Pele_Trinity', 'Pele_Trinity')
...
my_percentage <- c(83.3, 0.8, 7.9, 8.0, 57.5, 39.1, 0.4, 3.0, 33.3, 66.1, 0.2, 0.4, 19.6, 79.4, 0.5, 0.5, 70.5, 7.0, 4.5, 18.0, 45.1, 49.1, 1.2, 4.6, 30.8, 68.4, 0.2, 0.6, 24.6, 74.3, 0.2, 0.9)
my_values <- c(795, 8, 75, 76, 549, 373, 4, 28, 318, 631, 2, 3, 187, 757, 5, 5, 673, 67, 43, 171, 430, 468, 11, 45, 294, 653, 2, 5, 235, 709, 2, 8)
